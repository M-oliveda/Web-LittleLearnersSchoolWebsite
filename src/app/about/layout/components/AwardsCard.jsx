export default function AwardsCard(props) {
  return (
    <article className="mx-3 my-7 flex-grow rounded-[10px] border-2 border-grey-15 bg-white pb-[30px] pl-[30px] pr-[40px] drop-shadow-customone 2xl:drop-shadow-customonexl">
